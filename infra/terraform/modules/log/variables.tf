...
variable "sku" {
  description = "(Optional) Specifies the sku of the Azure Log Analytics Workspace. Default is `PerGB2018`."
  type        = string
  nullable    = false
  default     = "PerGB2018"
...
variable "retention_in_days" {
  description = " (Optional) Specifies the Azure Log Analytics Workspace data retention in days. Possible values are either 7 (Free Tier only) or a range between 30 and 730. Default is 30."
  type        = number
  nullable    = true
  default     = 30
